# rails-knowledge-base-tutorial
Rails Tutorial: Creating an Impressive Knowledge Base with Content Powered by ButterCMS

## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [Rails Tutorial: Creating an Impressive Knowledge Base with Content Powered by ButterCMS](https://buttercms.com/blog/rails-tutorial-creating-a-knowledge-base/), and will not be actively maintained.
